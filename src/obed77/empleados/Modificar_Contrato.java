...
import static obed77.empleados.Contrato_Empleado.tabla_contratos;
public class Modificar_Contrato extends javax.swing.JFrame {
...
Shape shape = null;
 ...
 public void Inicio(){
      try {
            ...
            this.jdc_fechae.setMaxSelectableDate(date.parse(f));
            this.jdc_fecha.setMaxSelectableDate(date.parse(f));
        } catch (ParseException ex) {
            Logger.getLogger(Modificar_Contrato.class.getName()).log(Level.SEVERE, null, ex);
        }
        int fsel = tabla_contratos.getSelectedRow();
        String id = tabla_contratos.getValueAt(fsel, 0).toString();
        this.lab_id_con.setText(id);
        llenarHorario();
        llenarCargos();
 ...
 public void llenarDatos()
 {
    ...
    try {
        ...
        if(rs.first())
        {
            in=rs.getDate("fecha_ingreso");
            fee=rs.getString("fecha_egreso");
            if(fee.equals("No Aplica"))
            {
                ou=null;
            }else
            {
                ou=rs.getDate("fecha_egreso");
            }
            cbx_base.setSelected(rs.getBoolean("con_sueldo"));
            cbx_alim.setSelected(rs.getBoolean("con_ticket"));
            cbx_com.setSelected(rs.getBoolean("con_comision"));
            cbx_des.setSelected(rs.getBoolean("con_destajo"));
            sd=rs.getDouble("sueldo_final");
            carg=rs.getString("fk_cargo");
            hor=rs.getString("fk_horario");
            
            if(cbx_base.isSelected())
            {
               sm = Math.rint((sd*30)*100)/100;
               txt_sueldo.setValue(sm);
            }else
            {
                txt_sueldo.setValue(false);
            }
            txt_sueldo_dia.setValue(sd);
            jdc_fecha.setDate(in);
            jdc_fechae.setDate(ou);
            cbo_cargo.setSelectedItem(carg);
            cbo_horario.setSelectedItem(hor);
        }
    } catch (ClassNotFoundException ex) {
        Logger.getLogger(Modificar_Contrato.class.getName()).log(Level.SEVERE, null, ex);
    } catch (SQLException ex) {
...
void guardar(){
    try {
        ...
        Date fece=this.jdc_fechae.getDate();
        ...
        ClaseContrato contrato = new ClaseContrato(id, fecha,fechae, sueldo_inicial, sueldo_final, horario,empleado,cargo,base,alim,com,des);
        Gest_contrato in = new Gest_contrato();
        boolean r;
        r=in.Modificar(contrato);
        if (r==false)
        {
    ...
    private void initComponents() {
        ...
        panel.setBorder(javax.swing.BorderFactory.createTitledBorder("Modificar Contrato"));
        ...
        btn_limpiar.setText("Reestablecer");
        ...
        jdc_fechae.setDateFormatString("yyyy/MM/dd");
        jdc_fechae.setMaxSelectableDate(new java.util.Date(253370784688000L));
        jdc_fechae.setMinimumSize(new java.awt.Dimension(100, 20));
        jdc_fechae.setOpaque(false);
        jdc_fechae.setPreferredSize(new java.awt.Dimension(100, 20));
            ...
            .addGroup(panelLayout.createSequentialGroup()
                .addGroup(panelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(panelLayout.createSequentialGroup()
                        ...
                        .addGap(9, 9, 9)
                        .addComponent(jdc_fechae, javax.swing.GroupLayout.PREFERRED_SIZE, 125, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addGap(96, 96, 96)
            ...
            .addGroup(panelLayout.createSequentialGroup()
                ...
                .addGroup(panelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(panelLayout.createSequentialGroup()
                        .addGap(35, 35, 35)
                        .addGroup(panelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                            .addComponent(jdc_fechae, javax.swing.GroupLayout.DEFAULT_SIZE, 25, Short.MAX_VALUE)
...
calcular();        // TODO add your handling code here:
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Modificar_Contrato.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Modificar_Contrato().setVisible(true);
            }
        });
    }
